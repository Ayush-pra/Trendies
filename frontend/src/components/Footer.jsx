...
// const Footer = () => {
//   return (
//     <footer className="w-full bg-gradient-to-b from-[#f8fdfd] to-[#dbfcfc] border-t border-gray-200">
...
//               <span className="text-2xl font-bold text-gray-900">Trendies</span>
//             </div>
//             <p className="text-gray-600 mb-6 max-w-md text-lg">
//               Your one-stop destination for the latest fashion & lifestyle. Discover curated collections that redefine your style.
//             </p>
...
//               <li><a href="#" className="text-gray-600 hover:text-gray-900 transition-colors">Private Policy</a></li>
//             </ul>
//           </div>
...
//                 </svg>
//                 <span className="text-gray-600">123 Fashion Street, Trend City, TC 10101</span>
//               </li>
//               <li className="flex items-start">
//                 <svg className="w-5 h-5 text-gray-500 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
//                 </svg>
//                 <span className="text-gray-600">support@trendies.com</span>
//               </li>
//               <li className="flex items-start">
//                 <svg className="w-5 h-5 text-gray-500 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
//           <p className="text-gray-500 text-sm">© {new Date().getFullYear()} Trendies. All rights reserved.</p>
