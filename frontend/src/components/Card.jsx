    ...
    >
      ...
      <div className='w-full h-64 bg-white rounded-sm overflow-hidden relative group'>
        ...
        <button
          ...
          className='absolute top-2 right-2 w-9 h-9 rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center transition-all duration-200 hover:bg-black/60 hover:scale-110 z-10'
