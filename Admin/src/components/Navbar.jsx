...
const Navbar = () => {
  ...
  return (
    <div className='w-[100vw] h-[70px] bg-[#020617]/90 z-20 fixed top-0 flex items-center justify-between px-[30px] shadow-md shadow-black'>
      ...
      <button className='text-[16px] hover:border-[2px] border-[#89daea] cursor-pointer bg-red-600 py-[8px] px-[20px] rounded-2xl text-white' onClick={() => { logout() }}>{loading ? <Loading /> : "Logout"}</button>
    </div>
  );
}
